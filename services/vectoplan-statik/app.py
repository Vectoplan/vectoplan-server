"""Application factory for the standalone VECTOPLAN structural workspace."""
...
def create_app(config_name: str | None = None) -> Flask:
    """Create one completely configured, but deliberately standalone, service."""
    ...
    @app.get("/")
    def root_redirect():
        return redirect(url_for("statik.index"))
...
if __name__ == "__main__":
    application = create_app(os.getenv("VECTOPLAN_STATIK_CONFIG"))
    application.run(
