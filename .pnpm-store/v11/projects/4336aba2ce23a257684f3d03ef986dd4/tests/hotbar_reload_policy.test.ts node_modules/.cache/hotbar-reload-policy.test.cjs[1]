...
// src/frontend/api/editor_inventory_api_client.ts
function resolveEditorInventoryPayloadSelectedSlot(payload, fallback, hotbarSize) {
  const record = asRecord(payload);
  const inventory = asRecord(record.inventory);
  const source = Object.keys(inventory).length > 0 ? inventory : record;
  const candidate = source.selectedSlot ?? source.selected_slot ?? source.defaultSelectedSlot ?? source.default_selected_slot;
  return asInteger(
    candidate,
    fallback,
    0,
...
var FORBIDDEN_DEBUG_BLOCK_TYPE_IDS2 = [
  "debug_grass",
  "debug_dirt"
];
var FORBIDDEN_DEBUG_BLOCK_TYPE_ID_SET = new Set(
  FORBIDDEN_DEBUG_BLOCK_TYPE_IDS2
);
...
// src/frontend/render/material_appearance_registry.ts
var TEXTURE_LOADER = new TextureLoader();

// src/frontend/runtime/physics/physics_models.ts
var ZERO_PHYSICS_VECTOR = Object.freeze({
  x: 0,
  y: 0,
  z: 0
});
var ZERO_PHYSICS_ANGLES = Object.freeze({
  yaw: 0,
  pitch: 0,
  roll: 0
});
var EMPTY_COLLISION_FLAGS = Object.freeze({
  grounded: false,
  hitCeiling: false,
  hitWallX: false,
  hitWallZ: false,
...
var EMPTY_PLAYER_MOVEMENT_INTENT = Object.freeze({
  forward: 0,
  right: 0,
  sprintHeld: false,
  jumpPressed: false,
...
var PHYSICS_DEFAULT_FIXED_TIME_STEP_SECONDS = 1 / 60;
var PHYSICS_DEFAULT_MAX_FRAME_DELTA_SECONDS = 0.25;
var PHYSICS_DEFAULT_MAX_SUB_STEPS = 4;
var PHYSICS_DEFAULT_WALK_SPEED = 4.25;
var PHYSICS_DEFAULT_SPRINT_SPEED = 9.5;
var PHYSICS_DEFAULT_AIR_CONTROL_SPEED = 2.35;
var PHYSICS_DEFAULT_FLY_SPEED = 6.5;
var PHYSICS_DEFAULT_FLY_SPRINT_SPEED = 15;
var PHYSICS_DEFAULT_JUMP_VELOCITY = 6.25;
var PHYSICS_DEFAULT_GRAVITY = -18;
var PHYSICS_DEFAULT_MAX_FALL_SPEED = -32;
var PHYSICS_DEFAULT_GROUND_SNAP_DISTANCE = 0.08;
var PHYSICS_DEFAULT_PLAYER_WIDTH = 0.6;
var PHYSICS_DEFAULT_PLAYER_HEIGHT = 1.8;
var PHYSICS_DEFAULT_PLAYER_EYE_HEIGHT = 1.62;
var PHYSICS_DEFAULT_PLAYER_SKIN_WIDTH = 1e-3;
var PHYSICS_DEFAULT_DOUBLE_TAP_WINDOW_MS = 280;
var PHYSICS_DEFAULT_ALLOW_JUMP_BEFORE_FLIGHT_TOGGLE = true;
var PHYSICS_MIN_FIXED_TIME_STEP_SECONDS = 1 / 240;
var PHYSICS_MAX_FIXED_TIME_STEP_SECONDS = 1 / 20;
var PHYSICS_DEFAULT_MISSING_CHUNK_POLICY = "treat_as_air";
var DEFAULT_PLAYER_AABB_COLLIDER = Object.freeze({
  kind: "aabb",
...
var DEFAULT_PHYSICS_TIMING_CONFIG = Object.freeze({
...
var DEFAULT_PHYSICS_MOVEMENT_CONFIG = Object.freeze({
...
var DEFAULT_PHYSICS_INPUT_CONFIG = Object.freeze({
...
var DEFAULT_PHYSICS_MISSING_CHUNK_CONFIG = Object.freeze({
  policy: PHYSICS_DEFAULT_MISSING_CHUNK_POLICY,
  blockHorizontalMovement: false,
  blockVerticalMovement: false
});
var DEFAULT_PHYSICS_DEBUG_CONFIG = Object.freeze({
  enabled: false,
  exposeToStore: true,
  includeCollisionCells: false
});
var DEFAULT_PHYSICS_CONFIG = Object.freeze({
  enabled: true,
...
var DEFAULT_PLAYER_SPAWN_POSITION = Object.freeze({
  x: 0,
  y: 8,
  z: 0
});
var DEFAULT_PLAYER_SPAWN_ANGLES = Object.freeze({
  yaw: 0,
  pitch: 0,
  roll: 0
});
...
var DEFAULT_PLAYER_STATE_POSITION = Object.freeze({
  x: 0,
  y: 8,
  z: 0
});
var DEFAULT_PLAYER_STATE_ANGLES = Object.freeze({
  yaw: 0,
  pitch: 0,
  roll: 0
});

// src/frontend/inventory/hotbar_controller.ts
var DEFAULT_SLOT_COUNT = Number(DEFAULT_EDITOR_INVENTORY_SLOT_COUNT) || 9;
function isSilentHotbarReloadReason(reason) {
  return reason?.startsWith("library-user-inventory-frame") ?? false;
}

// tests/hotbar_reload_policy.test.ts
(0, import_node_test.default)("restores the server-side inventory selection instead of the bootstrap default", () => {
...
(0, import_node_test.default)("uses the bootstrap selection only when the response has no selection", () => {
  import_strict.default.equal(
    resolveEditorInventoryPayloadSelectedSlot({ inventory: {} }, 3, 9),
    3
  );
});
(0, import_node_test.default)("keeps iframe slot synchronization in the background", () => {
  import_strict.default.equal(isSilentHotbarReloadReason("library-user-inventory-frame-sync"), true);
  import_strict.default.equal(isSilentHotbarReloadReason("library-user-inventory-frame-sync-ready"), true);
});
(0, import_node_test.default)("keeps normal inventory loads visible", () => {
  import_strict.default.equal(isSilentHotbarReloadReason("hotbar-reload"), false);
  import_strict.default.equal(isSilentHotbarReloadReason(void 0), false);
});
