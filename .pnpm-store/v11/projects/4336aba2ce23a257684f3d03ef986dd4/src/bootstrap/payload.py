...
def _build_chunks_payload(source: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "viewDistance": _coerce_int(chunks.get("viewDistance", source.get("chunks_view_distance")), _default_attr("DEFAULT_CHUNKS_VIEW_DISTANCE", 7), 0, 512),
        ...
        "unloadDistance": _coerce_int(chunks.get("unloadDistance", source.get("chunks_unload_distance")), _default_attr("DEFAULT_CHUNKS_UNLOAD_DISTANCE", 9), 0, 1024),
        "maxLoadedChunks": _coerce_int(chunks.get("maxLoadedChunks", source.get("chunks_max_loaded_chunks")), _default_attr("DEFAULT_CHUNKS_MAX_LOADED_CHUNKS", 384), 1, 100_000),
